              ...
              <div key={i} className="relative">
                <div className="flex flex-col items-center justify-center py-3 group">
                  <div className='mx-3 flex flex-col items-center justify-center py-3 space-y-4 group'>
                    <div className="transform group-hover:scale-110 transition-transform duration-200 text-gray-800 cursor-pointer">
                      {service.icon}
                    </div>
                    <h2 className="text-xs md:text-xs text-gray-800 text-center font-medium">
                      {service.title}
                    </h2>
                  </div>
                  {i !== services.length - 1 && (
      ...
      <div className="container mx-auto px-4 pt-32 pb-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="space-y-6">
            <h2 className="font-semibold text-goldMid tracking-widest text-md">MY ACCOUNT</h2>
            <p className="text-sm leading-6 text-slate-500 hover:scale-105 inline-block transition-transform duration-200 hover:text-goldMid cursor-pointer">
