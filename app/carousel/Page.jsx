      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/50 to-transparent">
          <div className="absolute left-0 w-full md:w-[50%] top-1/2 transform -translate-y-1/2 text-white p-8 space-y-4">
            <h2 className="text-sm md:text-5xl font-grandiflora mb-0 md:mb-4 text-[#CFA500]">
              IMPECCABLE CRAFTSMANSHIP AND FINESSE
            </h2>
            <p className="w-[70%] break-words text-xs md:text-sm text-slate-300 font-light tracking-wider">
